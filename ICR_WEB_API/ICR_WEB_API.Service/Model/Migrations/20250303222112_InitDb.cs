    ...
    public partial class InitDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RatingScaleItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RatingScaleItems_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Answers_RatingScaleItems_RatingItemId",
                        column: x => x.RatingItemId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RatingScaleItems_QuestionId",
                table: "RatingScaleItems",
                column: "QuestionId");
